...
<body id="page-top">
    ...
    <header class="masthead d-flex align-items-center">
        <div class="container px-4 px-lg-5 text-center">
            ...
            <h3 class="mb-5 text-capitalize"><em>{{auth()->user()->name}}</em></h3>
            <a class="btn btn-primary btn-xl" href="{{url('/home')}}">Continue</a>
        </div>
        <!-- Footer-->
        <footer class="footer text-center">
            <div class="container px-4 px-lg-5">
                ...
                <p class="text-muted small mb-0">Copyright &copy; Project 2022</p>
            </div>
        </footer>
